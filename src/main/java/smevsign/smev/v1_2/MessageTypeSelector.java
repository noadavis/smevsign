...
@XmlRootElement(name = "MessageTypeSelector", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.2")
public class MessageTypeSelector {

    @XmlElement(name = "NamespaceURI", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.2")
    @XmlSchemaType(name = "anyURI")
    protected String namespaceURI;
    @XmlElement(name = "RootElementLocalName", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.2")
    ...
    @XmlElement(name = "NodeID", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.2")
