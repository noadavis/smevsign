...
@XmlRootElement(name = "RefAttachmentHeaderList", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1")
public class RefAttachmentHeaderList {

    @XmlElement(name = "RefAttachmentHeader", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1", required = true)
