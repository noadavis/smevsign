...
@XmlRootElement(name = "AttachmentHeaderList", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1")
public class AttachmentHeaderList {

    @XmlElement(name = "AttachmentHeader", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1", required = true)
