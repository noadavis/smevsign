...
import smevsign.smev.v1_3.AckRequest;
import smevsign.smev.v1_3.AckTargetMessage;
...
public class AckXml extends AbstractXmlBuilder {
    ...
    private void createRequest() {
        ...
        if (signature != null) {
            ...
            setXml(Utils.convertJAXBObjectToXml(ackReq, "smevsign.smev.v1_3.AckRequest", null));
        } else {
    ...
    private void createResponse() {
        ...
        sb.append("<ns2:AckResponse xmlns=\"urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.3\"");
        sb.append(" xmlns:ns2=\"urn://x-artefacts-smev-gov-ru/services/message-exchange/types/1.3\"");
        sb.append(" xmlns:ns3=\"urn://x-artefacts-smev-gov-ru/services/message-exchange/types/faults/1.3\"/>");
