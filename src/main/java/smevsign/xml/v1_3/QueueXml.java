...
import smevsign.smev.v1_3.GetRequestRequest;
import smevsign.smev.v1_3.GetResponseRequest;
import smevsign.smev.v1_3.MessageTypeSelector;
import smevsign.smev.v1_3.XMLDSigSignatureType;
    ...
    */
    ...
    private void createGetRequestRequest() {
        this.signValues.setElementNs(
                "MessageTypeSelector",
                "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.3"
        );
        ...
        if (signature != null) {
            ...
            setXml(Utils.convertJAXBObjectToXml(getReq, "smevsign.smev.v1_3.GetRequestRequest", null));
        } else {
    ...
    private void createGetResponseRequest() {
        ...
        if (signature != null) {
            dSign.setAny(Utils.getElementFromClass(signature));
            setXml(Utils.convertJAXBObjectToXml(getRes, "smevsign.smev.v1_3.GetResponseRequest", null));
        } else {
    ...
    private void createGetRequestResponse() {
        ...
        sb.append("<st1:GetRequestResponse xmlns:sb1=\"urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.3\"");
        sb.append(" xmlns:sf1=\"urn://x-artefacts-smev-gov-ru/services/message-exchange/types/faults/1.3\"");
        sb.append(" xmlns:st1=\"urn://x-artefacts-smev-gov-ru/services/message-exchange/types/1.3\"/>");
    ...
    private void createGetResponseResponse() {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Header/><soap:Body>");
        sb.append("<st1:GetResponseResponse xmlns:sb1=\"urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.3\"");
        sb.append(" xmlns:sf1=\"urn://x-artefacts-smev-gov-ru/services/message-exchange/types/faults/1.3\"");
        sb.append(" xmlns:st1=\"urn://x-artefacts-smev-gov-ru/services/message-exchange/types/1.3\"/>");
        sb.append("</soap:Body></soap:Envelope>");
        setXml(sb.toString());
